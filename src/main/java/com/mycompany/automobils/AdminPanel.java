...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order No.", "Model", "Name", "Email", "Price", "Address", "Status"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 895, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql?user=root&password=root")) {
                ...
                while (rs.next()) {
                    ...
                    String tbData[] = {name, email, card, address};
    ...
    public void orderData() {
        String name, email, orderno, address, price, model, status;
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Statement stmt;
            ResultSet rs;
